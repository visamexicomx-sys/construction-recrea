...
z6 = load('gen-casas-zonas6.py', 'z6')
z7 = load('gen-casas-zonas7.py', 'z7')
z8 = load('gen-casas-zonas8.py', 'z8')
...
ZONES = {}
for mod, zdict, names in [(z1, z1.ZONE, z1.ZNAME), (z2, z2.ZONE2, None), (z3, z3.ZONE3, None), (z4, z4.ZONE4, None), (z5, z5.ZONE5, None), (z6, z6.ZONE6, None), (z7, z7.ZONE7, None), (z8, z8.ZONE8, None)]:
