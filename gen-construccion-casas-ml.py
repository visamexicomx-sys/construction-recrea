...
LOCS = ['playa-del-carmen', 'cancun', 'tulum', 'riviera-maya']
...
'en': dict(locale='en_US',
  ...
  title='House Construction in {city} | Turnkey New Builds | Recrea',
  desc='House construction in {city}: turnkey new builds at a fixed price. 2026 cost per m², step-by-step process, permits and timelines. 18+ years, 196+ projects.',
...
'ru': dict(locale='ru_RU',
  ...
  title='Строительство домов в {city} | Дом под ключ | Recrea',
  desc='Строительство домов в {city}: дом под ключ по фиксированной цене. Стоимость за м² 2026, процесс по этапам, разрешения и сроки. 18+ лет, 196+ проектов.',
...
'de': dict(locale='de_DE',
  h1='Hausbau in {city}',
  title='Hausbau in {city} | Schlüsselfertige Neubauten | Recrea',
  desc='Hausbau in {city}: schlüsselfertiger Neubau zum Festpreis. Kosten pro m² 2026, Ablauf Schritt für Schritt, Genehmigungen und Bauzeiten. 18+ Jahre, 196+ Projekte.',
...
'fr': dict(locale='fr_FR',
  ...
  title='Construction de Maisons à {city} | Clé en Main | Recrea',
  desc='Construction de maisons à {city} : neuf clé en main à prix fixe. Coût au m² 2026, processus étape par étape, permis et délais. 18+ ans, 196+ projets.',
...
'zh': dict(locale='zh_CN',
  h1='{city}住宅建造',
  title='{city}住宅建造 | 整包交钥匙工程 | Recrea',
  desc='{city}住宅建造：固定总价的交钥匙新建工程。2026年每平方米造价、分阶段流程、许可与工期。18年以上经验，196+个项目。',
...
CITY = {
 'en': {'playa-del-carmen': 'Playa del Carmen', 'cancun': 'Cancún', 'tulum': 'Tulum', 'riviera-maya': 'the Riviera Maya'},
 'ru': {'playa-del-carmen': 'Плая-дель-Кармен', 'cancun': 'Канкуне', 'tulum': 'Тулуме', 'riviera-maya': 'Ривьере-Майя'},
 'de': {'playa-del-carmen': 'Playa del Carmen', 'cancun': 'Cancún', 'tulum': 'Tulum', 'riviera-maya': 'der Riviera Maya'},
 'fr': {'playa-del-carmen': 'Playa del Carmen', 'cancun': 'Cancún', 'tulum': 'Tulum', 'riviera-maya': 'la Riviera Maya'},
 'zh': {'playa-del-carmen': '普拉亚德尔卡门', 'cancun': '坎昆', 'tulum': '图卢姆', 'riviera-maya': '里维埃拉玛雅'},
}
ZONES = {
 'en': {'playa-del-carmen': 'Playacar, Corasol, Zazil-Ha, Selvamar and Mayakoba',
 ...
 'ru': {'playa-del-carmen': 'Плаякар, Корасоль, Сасиль-Ха, Сельвамар и Майякоба',
 ...
 'de': {'playa-del-carmen': 'Playacar, Corasol, Zazil-Ha, Selvamar und Mayakoba',
 ...
 'fr': {'playa-del-carmen': 'Playacar, Corasol, Zazil-Ha, Selvamar et Mayakoba',
 ...
 'zh': {'playa-del-carmen': 'Playacar、Corasol、Zazil-Ha、Selvamar 与 Mayakoba',
...
NORM = {
 ...
 'fr': {'playa-del-carmen': 'À Solidaridad, tout commence par le certificat d’usage du sol et le PDU en vigueur : il fixe le nombre de niveaux et la densité constructible de votre terrain. Le permis exige des plans signés par un DRO enregistré à la mairie, une note de structure et les plans des réseaux. Si le terrain jouxte la mangrove, la dune ou un cénote, s’ajoute l’autorisation environnementale de l’État.',
 ...
 'zh': {'playa-del-carmen': '在 Solidaridad 市，流程从土地用途证明和现行 PDU 规划开始：它决定您的地块可建层数与建筑密度。施工许可需要由在该市注册的 DRO 签署的图纸、结构计算书与管线图。若地块毗邻红树林、沙丘或天然井（cenote），还需州级环保许可。',
...
SOIL = {
 'en': {'playa-del-carmen': 'The ground is limestone karst: good bearing capacity, but with hidden cavities and cenotes. That is why we start with a soil-mechanics study — it decides between strip footings, a mat foundation or piles, and prevents the classic overrun of discovering a void once the build is underway.',
 ...
 'ru': {'playa-del-carmen': 'Основание — известняковый карст: несущая способность хорошая, но с пустотами и скрытыми сенотами. Поэтому мы начинаем с геологии — она определяет, будет ли фундамент ленточным, монолитной плитой или на сваях, и снимает классический риск обнаружить каверну уже в ходе стройки.',
 ...
 'fr': {'playa-del-carmen': 'Le sous-sol est un karst calcaire : bonne portance, mais avec des cavités et des cénotes cachés. D’où l’étude de sol dès le départ — elle décide entre semelles filantes, radier ou pieux, et évite le surcoût classique de découvrir un vide une fois le chantier lancé.',
 ...
 'zh': {'playa-del-carmen': '地层为石灰岩喀斯特：承载力良好，但存在空洞和隐蔽的天然井。因此我们先做土力学勘察，据此确定采用条形基础、筏板基础还是桩基，避免开工后才发现溶洞的典型超支。',
...
EXTRA = {
 'en': {'playa-del-carmen': 'Playa del Carmen is the most balanced market on the coast: land cheaper than Tulum, established local trades and suppliers, and the best cost-to-appreciation ratio whether you build to live or to rent.',
 ...
 'ru': {'playa-del-carmen': 'Плая-дель-Кармен — самый сбалансированный рынок побережья: земля дешевле, чем в Тулуме, устоявшиеся местные бригады и поставщики, лучшее соотношение затрат и роста стоимости — и для жизни, и под аренду.',
 ...
 'de': {'playa-del-carmen': 'Playa del Carmen ist der ausgewogenste Markt der Küste: günstigeres Land als Tulum, etablierte Handwerker und Lieferanten vor Ort und das beste Verhältnis von Kosten zu Wertsteigerung — ob zum Wohnen oder Vermieten.',
 ...
 'fr': {'playa-del-carmen': 'Playa del Carmen est le marché le plus équilibré de la côte : terrain moins cher qu’à Tulum, artisans et fournisseurs locaux établis, et le meilleur rapport coût/plus-value, pour y vivre comme pour louer.',
 ...
 'zh': {'playa-del-carmen': '普拉亚德尔卡门是海岸线上最均衡的市场：土地比图卢姆便宜，本地工班与供应商成熟，自住或出租的性价比与增值潜力都最好。',
...
FAQX = {
 'en': {'playa-del-carmen': [('Do you handle the permits?', 'Yes: land use, the Solidaridad building licence, DRO, CFE and water hook-ups, plus the environmental permit if the lot needs one.'),
 ...
 'ru': {'playa-del-carmen': [('Разрешения оформляете вы?', 'Да: назначение земли, разрешение на строительство в Solidaridad, DRO, подключение CFE и воды, а также экологическое согласование, если участок этого требует.'),
 ...
 'de': {'playa-del-carmen': [('Übernehmen Sie die Genehmigungen?', 'Ja: Nutzungsart, Baugenehmigung in Solidaridad, DRO, CFE- und Wasseranschluss sowie die Umweltgenehmigung, falls das Grundstück sie braucht.'),
 ...
 'fr': {'playa-del-carmen': [('Gérez-vous les permis ?', 'Oui : usage du sol, permis de construire à Solidaridad, DRO, raccordements CFE et eau, ainsi que l’autorisation environnementale si le terrain l’exige.'),
 ...
 'zh': {'playa-del-carmen': [('许可由你们办理吗？', '是。土地用途、Solidaridad 市施工许可、DRO、CFE 供电与供水接入，若地块需要还包括环保许可。'),
...
LINKS = {
 'en': {'playa-del-carmen': [('/cost-to-build-house-playa-del-carmen/', 'How much does it cost to build a house?'), ('/construction-permits-playa-del-carmen/', 'Construction permits in Playa del Carmen'), ('/construction-companies-playa-del-carmen/', 'Construction companies in Playa del Carmen'), ('/luxury-villa-construction-playa-del-carmen/', 'Luxury villas'), ('/calculator/', 'Cost calculator'), ('/blog/', 'Construction guides')],
 ...
 'ru': {'playa-del-carmen': [('/skolko-stoit-postroit-dom-playa-del-carmen/', 'Сколько стоит построить дом'), ('/razresheniya-i-licenzii-riviera-maya/', 'Разрешения, лицензии и DRO'), ('/stroitelstvo-vill-playa-del-carmen/', 'Строительство вилл'), ('/remont-domov-playa-del-carmen/', 'Ремонт домов'), ('/kalkulyator/', 'Калькулятор стоимости'), ('/blog-ru/', 'Гиды по строительству')],
        ...
        'riviera-maya': [('/stroitelstvo-domov-playa-del-carmen/', 'Строительство домов в Плая-дель-Кармен'), ('/stroitelstvo-domov-cancun/', 'Строительство домов в Канкуне'), ('/stroitelstvo-domov-tulum/', 'Строительство домов в Тулуме'), ('/razresheniya-i-licenzii-riviera-maya/', 'Разрешения, лицензии и DRO'), ('/kalkulyator/', 'Калькулятор стоимости'), ('/blog-ru/', 'Гиды по строительству')]},
 'de': {'playa-del-carmen': [('/hausbau-kosten-playa-del-carmen/', 'Was kostet ein Hausbau?'), ('/baugenehmigungen-lizenzen-riviera-maya/', 'Baugenehmigungen, Lizenzen und DRO'), ('/luxusvilla-bau-playa-del-carmen/', 'Luxusvillen'), ('/hausrenovierung-playa-del-carmen/', 'Hausrenovierung'), ('/kostenrechner/', 'Kostenrechner'), ('/blog-de/', 'Bau-Leitfäden')],
        ...
        'riviera-maya': [('/hausbau-playa-del-carmen/', 'Hausbau in Playa del Carmen'), ('/hausbau-cancun/', 'Hausbau in Cancún'), ('/hausbau-tulum/', 'Hausbau in Tulum'), ('/baugenehmigungen-lizenzen-riviera-maya/', 'Genehmigungen, Lizenzen und DRO'), ('/kostenrechner/', 'Kostenrechner'), ('/blog-de/', 'Bau-Leitfäden')]},
 'fr': {'playa-del-carmen': [('/prix-construction-maison-playa-del-carmen/', 'Prix de construction d’une maison'), ('/permis-et-licences-construction-riviera-maya/', 'Permis, licences et DRO'), ('/construction-villa-luxe-playa-del-carmen/', 'Villas de luxe'), ('/renovation-maison-playa-del-carmen/', 'Rénovation de maison'), ('/calculateur/', 'Calculateur de coûts'), ('/blog-fr/', 'Guides de construction')],
        ...
        'riviera-maya': [('/construction-de-maisons-playa-del-carmen/', 'Construction de maisons à Playa del Carmen'), ('/construction-de-maisons-cancun/', 'Construction de maisons à Cancún'), ('/construction-de-maisons-tulum/', 'Construction de maisons à Tulum'), ('/permis-et-licences-construction-riviera-maya/', 'Permis, licences et DRO'), ('/calculateur/', 'Calculateur de coûts'), ('/blog-fr/', 'Guides de construction')]},
 'zh': {'playa-del-carmen': [('/playa-del-carmen-jianfang-chengben/', '建房成本是多少'), ('/jianzhu-xuke-yu-zhizhao-riviera-maya/', '建筑许可与DRO'), ('/haohua-bieshu-playa-del-carmen/', '豪华别墅'), ('/fangwu-fanxin-playa-del-carmen/', '房屋翻新'), ('/jisuanqi/', '造价计算器'), ('/blog-zh/', '建筑指南')],
        ...
        'riviera-maya': [('/zhuzhai-jianzao-playa-del-carmen/', '普拉亚德尔卡门住宅建造'), ('/zhuzhai-jianzao-cancun/', '坎昆住宅建造'), ('/zhuzhai-jianzao-tulum/', '图卢姆住宅建造'), ('/jianzhu-xuke-yu-zhizhao-riviera-maya/', '建筑许可与DRO'), ('/jisuanqi/', '造价计算器'), ('/blog-zh/', '建筑指南')]},
}
